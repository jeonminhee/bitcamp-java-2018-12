...
Set-Cookie: name2=홍길동 <--- URL 인코딩 하지않은 상태
Set-Cookie: name3=%ED%99%8D%EA%B8%B8%EB%8F%99 <--- URL 인코딩한 예
Content-Type: text/plain;charset=UTF-8
Content-Length: 36
Date: Wed, 03 Apr 2019 01:03:17 GMT
*/
    
    // 쿠키 생성
    // => 이름과 값으로 생성한다.
    // => 쿠키의 유효기간을 설정하지 않으면 웹 브라우저가 종료될 때까지 유지된다.
    //    웹 브라우저를 종료하면 유효기간이 지정되지 않은 쿠키를 모두 삭제한다.
