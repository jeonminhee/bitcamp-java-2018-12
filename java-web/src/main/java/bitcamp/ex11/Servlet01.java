...
public class Servlet01 extends HttpServlet {
  ...
  protected void service(
    ...
    //    그래서 서버는 클라이언트가 요청 할 때 마다 누구인지 알 수 없다.
    // => 이를 해결하기 위해 클라이언트가 접속하면 웹 서버는 그 클라이언트를 위한
    //    고유 번호를 발급(쿠키 이용)한다.
    //    이 고유 번호를 '세션 아이디'라 부른다.
    // => 웹 브라우저는 세션 아이디를 보관해두었다가 그 서버에 요청할 때 마다
    //    세션 아이디를 보낸다.
    //    왜? 세션 아이디는 쿠키이기 때문이다.
...
/*
HTTP/1.1 200
Set-Cookie: JSESSIONID=5D853EF6E403C20772C10F267EF73DD1; Path=/java-web; HttpOnly
