...
public class Controller04_3 {
  ...
  //    
  // 테스트 :
  // http://localhost:8080/java-spring-webmvc/app1/c04_3/h1?model=sonata&maker=hyundai&capacity=5&auto=1&engine.model=bitok&engine.cc=1980&engine.valve=16
  @GetMapping("h1")
  @ResponseBody 
  public void handler1(
      ...
      boolean auto, // 프론트 컨트롤러가 String 값을 boolean로 변환해준다.
                     // "true", "false"는 대소문자 구분없이 true, false로 변환해준다.
                     // 1 ==> true, 0 ==> false로 변환해준다.
