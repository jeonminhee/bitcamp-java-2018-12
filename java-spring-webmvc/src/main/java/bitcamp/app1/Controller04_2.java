...
public class Controller04_2 {
  ...
  public void handler1(
      ...
      String name // 요청 파라미터 이름과 메서드 파라미터(아규먼트)의 
  ...
  // http://localhost:8080/java-spring-webmvc/app1/c04_2/h2?name1=kim&name2= <- 빈문자열이 넘어감
  // http://localhost:8080/java-spring-webmvc/app1/c04_2/h2?name1=kim <- null이 들어감
  // http://localhost:8080/java-spring-webmvc/app1/c04_2/h2?name2=park <- 에러 발생!
  @GetMapping("h2")
  @ResponseBody 
