...
public class Test08 {
  public static void main(String[] args) {
    ...
    // System.out.println((boolean)1); 에러! 자바는 정수 값을 true/false로 형변환 할 수 없다.
    
    // 작은 따옴표(single quote)의 리턴값은 2바이트 정수 값(UTF-16 코드)이다.
    ...
    /* 컴파일 오류!
    if ( 10 - 10 ) { //c언어에서는 0은 false, 그 외에 모든 수는 true이다. 자바는 아니다!
