...
public class Test02 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // 작업 :
    // 1) 부모 테이블의 데이터를 받는 클래스(예 : Board)에 
    //    자식 테이블의 데이터를 받는 필드(예 : AttachFiles)를 선언하라.
    // 2) SQL 매퍼 파일에서 <resultMap> 태그에 조인 정보를 정의한다.
    //
    // => 조인을 이용할 경우 다음과 같이 한번만 SQL을 실행하면 된다.
    //    mybatis가 SQL 매퍼에 정의된 대로 자식테이블의 데이터까지 인스턴스로 만들어 저장해준다.
