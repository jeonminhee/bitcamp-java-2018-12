...
public class Test01 {
  ...
  public static void main(String[] args) {
    ...
    //    게속 생성자에 그 클래스 정보를 추가해야 하는 번거로움이 발생한다.
    /*
    ApplicationContext iocContainer
      = new AnnotationConfigApplicationContext(AppConfig.class, DatabaseConfig.class, MybatisConfig.class);
     */
    // => 그래서 실무에서는 보통 main 역할을 하는 java config 클래스 정보만 넘긴다.
    //    나머지 Java config들은 @Configuration를 선언하여
    //    자신이 Spring IoC Container를 설정하는 클래스임을 알린다.
    ApplicationContext iocContainer
