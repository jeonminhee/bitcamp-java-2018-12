...
public class Test02 {
  ...
  public static void main(String[] args) {
    // 파라미터가 있는 명령어 블록 사용하기
    // => 파라미터가 있는 메서드 호출하기
    // => 파라미터가 있는 메서드를 호출하려면 반드시 그 파라미터가 원하는 타입의 값을 넘겨줘야한다.
    // m1(); // 컴파일 오류!
  ...
  // 그 값을 담을 변수를 메서드 정의에 선언해야한다. (String name, int age)
  // 이렇게 외부에서 값을 받는 변수를 "parameter(파라미터)"라고 부른다.
