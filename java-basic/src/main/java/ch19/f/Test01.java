...
public class Test01 {
  ...
  public static void main(String[] args) {
    ...
    // 3) Array는 자기것인양 LinkedList의 멤버를 사용하여 배열을 만들어 리턴한다.
...
/*
 ...
 => 식구의 종류에는 크게 두 가지가 있는데,
  1) static 식구(nested class)
    => 그 집안(바깥 클래스)에 static 멤버만 사용할 수 있다.
  2) non-static 식구
    => 그 집안(바깥 클래스)에 static 멤버 뿐만 아니라 non-static멤버도 사용 할 수 있다.
  non static 멤버?
  => 인스턴스 필드, 인스턴스 메서드, 생성자, 인스턴스 블록
  => 인스턴스 주소가 있어야만 사용할 수 있는 멤버들
*/
