...
public class Test02 {
  ...
  public static void main(String[] args) {
    ...
    // 4) annoymous class
    // => 클래스의 이름이 없다.
    // => 클래스를 정의하는 동시에 인스턴스를 생성해야한다.
    // => 클래스 이름이 없기 때문에 생성자를 정의 할 수 없다.
    // => 만약 인스턴스의 값을 초기화시키기 위해 복잡한 코드를 작성해야한다면,
    //    인스턴스 블록에 작성하라.
    ...
    // => 인터페이스를 지정하면 수퍼 클래스가 자동으로 Object가 된다.
    // => 그러면 호출할 생성자도 Object 클래스의 생성자여야한다.
    Pen obj3 = new Pen() {
      @Override
      public void write() {
