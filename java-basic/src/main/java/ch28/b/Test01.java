...
//        - 애노테이션을 정의할 때 유지범위를 지정하지 않으면 기본이 CLASS이다.
// => SOURCE 
//        - 컴파일 할 때 제거된다.
//        - 즉, .class 파일에 포함되지 않는다.
//        - 보통 소스 파일에서 애노테이션 값을 꺼내 다른 파일을 자동생성하는 도구를 만들 때 많이 사용한다.
// => RUNTIME
...
public class Test01 {
  ...
  public static void main(String[] args) {
    // Test01.class 파일을 편집기(Navigator)로 열어서 확인해보라!
    ...
    // 그러나 MyAnnotation3는 유지 범위가 RUNTIME 이기 때문에 실행 할 때 메모리에 로딩된다.
    // 따라서 실행 중에 애노테이션 정보를 추출 할 수 있다.
