...
public class Test07 {
  ...
  public static void main(String[] args) {
    ...
    // main()에서는 예외를 처리해야한다.
    // 정상적인 프로그램 종료를 수행해야한다.
    // => try ~ catch를 사용하지 않아도 된다는 것이 예외를 자동으로 처리하다는 것이 아니다.
    //    RuntimeException 계열의 예외도 최소한 main()에서는 처리해줘야한다.
    //
    // RuntimeException 예외는 메서드 선언부에 throws 절을 붙이지 않아도 되기때문에
  ...
  static void m3() {
    ...
    // 메서드 선언부에 "어떤 예외"를 던지는지 선언(보고)하지 않아도된다.
    // try~catch로 처리하지 않아도된다.
    m2();
  }
