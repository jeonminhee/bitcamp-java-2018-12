...
public class Test01 {
  ...
  public static void main(String[] args) {
    ...
    //    구현할 인터페이스 정보 목록,
    //    실제 작업을 수행하는 객체 
    // => 파라미터로 넘겨받은 인터페이스를 모두 구현한 클래스를 만들어 리턴한다.
    //
    // 클래스 로더
    ...
    */
    ...
    class MyHandler implements InvocationHandler {
      ...
      public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        // new ProxyInstance()가 생성한 객체에 대해 메서드를 호출할 때 마다 이 메서드가 호출된다.
        int a = (int) args[0]; // auto-unboxing => ((Ingeger)args[0]).intValue();
        int b = (int) args[1]; // auto-unboxing => ((Ingeger)args[1]).intValue();
