...
public class Test01 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // 클래스 정보 가지고 인스턴스 생성하기(deprecated : 비난받는 버전이다.)
    // => 기본 생성자가 있을 때만 가능하다.
    // => 향후 삭제 될 메서드이다. 가능한 사용하지 말라!
    ...
    // => 파라미터를 받는 생성자 꺼내기
    @SuppressWarnings("unchecked")
    Constructor<Student> c2 = (Constructor<Student>)clazz.getConstructor(String.class, String.class);
    
    // 파라미터를 받는 생성자를 실행할 때는 파라미터 값을 생성자에 넘겨줘야한다.
