...
CREATE TABLE prjt (
  ...
  cont       VARCHAR(255) NOT NULL COMMENT '설명', -- 설명
...
-- 프로젝트게시판
ALTER TABLE prjt_bod
  ADD CONSTRAINT FK_post_TO_prjt_bod -- 게시물 -> 프로젝트게시판
    FOREIGN KEY (
      post_id -- 게시물번호
    )
    REFERENCES post ( -- 게시물
