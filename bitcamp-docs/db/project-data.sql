...
insert into lms_lesson(titl, conts, sdt, edt, tot_hr, day_hr)
values('파이썬 프로그래밍', '프로그래밍 배우기', '2019-3-1', '2019-4-28', 300, 6);
insert into lms_lesson(titl, conts, sdt, edt, tot_hr, day_hr)
values('웹 프로그래밍', '프로그래밍 배우기', '2019-4-1', '2019-5-28', 300, 6);
insert into lms_lesson(titl, conts, sdt, edt, tot_hr, day_hr)
values('IoT 프로그래밍', '프로그래밍 배우기', '2019-5-1', '2019-6-28', 400, 6);
