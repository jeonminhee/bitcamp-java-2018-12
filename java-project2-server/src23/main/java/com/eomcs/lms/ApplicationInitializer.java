...
public class ApplicationInitializer implements ApplicationContextListener {
  ...
  public void contextInitialized(Map<String, Object> context) {
    try {
      ...
      // ServerApp 쪽에서 사용할 수 있도록 ApplicationContext를 Map에 저장한다.
  ...
  @Override
  public void contextDestroted(Map<String, Object> context) throws ApplicationContextException {
    // TODO Auto-generated method stub
    
  }
  
  public RequestMappingHandlerMapping prepareRequestMappingHandlerMapping(ApplicationContext iocContainer) {
    ...
    // ServerApp에서 꺼낼 수 있도록 RequestMappingHandlerMapping객체를 리턴한다.
