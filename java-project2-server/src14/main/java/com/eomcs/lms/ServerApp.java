// 14단계 : Mybatis 퍼시스턴트 프레임워크에 트랜잭션 관리자 도입하기
...
//    => SqlSession 객체를 통해 데이터 변경 작업들을 commit()하고 rollback하는 일을 한다.
// 4) DAO 변경
//    => DAO에서 데이터 변경(insert/update/delete) 후에 commit()하지말라!
...
//       예) PhotoBoardAddCommand, PhotoBoardUpdateCommand, PhotoBoardDeleteCommand,
//           LessonDeleteCommand
